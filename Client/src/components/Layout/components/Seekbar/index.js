                ...
                <div className="wrapper">
                    <div className="left">
                        <div className="image_music">
                            <a href="">
                                <img className="image_song" src="../img/albumn_99.jpg" alt="" width="100%"/>
                            </a>
                        </div>
                        <div className="desc">
                            <div className="title">
                        ...
                        <div className="heart">
                            <i className={'bx bxs-heart '+heart} id="heart" onClick={()=> handleHeart()}></i>
                        </div>
                    ...
                    <div className="mid">
                        <div className="controls">
                            ...
                            <button className={"btn-play " + play} onClick={() => handlePlay()}>
                                <span></span>
                                <span></span>
                            </button>
                        ...
                        <div className="times">
                            ...
                            <input type="range" className="seek_bar"/>
                    ...
                    <div className="right">
                        ...
                        <div className="volume_and_bar">
                            <div className="volume" onClick={()=> handleVolume()}>
                                <i className={'bx bxs-volume-full '+volume} id="iconVolume"></i>
                            </div>
                            <input type="range" value={currentVolume} onChange={e=> setCurrentVolume(e.target.value)} className="volume_bar" id="inputVolume"/>
                        </div>
                    </div>
                </div>
            </div>
