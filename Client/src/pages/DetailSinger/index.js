        ...
        <main className="detail_singer">
            ...
            <div className="container-main ">
                ...
                <div className="wrapper-featured_songs ">
                    ...
                    <div className="row songs-detail_singer">
                        <div className="col-sm-12">
                            <div className="container_song flex items-center justify-between">
                                ...
                                <div className="song flex items-center gap-4 ">
                                    <div className="stt ">
                                        1
                                    </div>
                                ...
                                <div className="listener text-gray-300">
                                    <p>33.222.111</p>
                                </div>
                                <div className="buttons">
                                    <button className="heart-albumn">
                                ...
                                <div className="time song_1 text-gray-300">
                                    <p>3:47</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row songs-detail_singer more">
                        <div className="col-sm-12">
                            <div className="container_song flex items-center justify-between">
